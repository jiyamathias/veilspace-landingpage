...
export default function Waitlist() {
  ...
  return (
    <section
      id="waitlist"
      style={{ textAlign: 'center', padding: '120px 5%' }}
    >
      <div style={{ maxWidth: 600, margin: '0 auto', position: 'relative' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: 16, color: 'var(--text-med)', marginBottom: 40, lineHeight: 1.6 }}>
            Join the waitlist and be first to enter VeilSpace when we launch on Android and iOS. No spam — just your invite.
          </p>
          ...
          {!submitted ? (
            <>
              <div style={{
                ...
                margin: '0 auto 20px', flexWrap: 'wrap', justifyContent: 'center',
              }}>
                <input
                  type="email"
                  value={email}
